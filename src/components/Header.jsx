...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-black  lg:px-36 ">
        ...
        <div className="flex items-center gap-4">
          <div className="relative">
            <select
              ...
              className="h-9 w-[60px] md:w-[70px] appearance-none rounded-md border border-zinc-700 bg-zinc-900 px-2 md:px-3 py-1 text-xs md:text-sm text-white shadow-sm transition-colors hover:border-zinc-600 focus:outline-none focus:ring-2 focus:ring-zinc-500"
            >
          ...
          <button className="  text-xs md:text-sm font-medium text-black  transition-colors focus:outline-none ">
